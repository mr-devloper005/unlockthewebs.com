export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'unlockthewebs',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Unlockthewebs',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'unlockthewebs.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://unlockthewebs.com',
